...
<head>
    ...
    <title>Registration Animation</title>
</head>
<style>
    * {
        margin: 0%;
    ...
    .box {
        ...
        width: 600px;
        border-radius: 20px;
        box-shadow: 5px 5px 2px solid gray;
    }
    ...
    .inner {
        background-color: rgba(225, 225, 247, 0.836);
        height: 12%;
        width: 50%;
        margin-left: 10;
        margin-top: 2%;
    ...
    div input {
        border: none;
        background-color: rgb(225, 225, 247, 0.836);
        padding: 10px;
    }

    .container {
        color: white;
        background-color: rgb(149, 101, 247);
        border-radius: 10px;
        text-align: center;
        padding-top: 9px;
        font-size: 18px;
